...
public void draw() {
  ...
  if (cubos[1].posicion()[1] <= 150) {
    cubos[1].desplazar(0, 0.5f, 0);
  } else {
    cubos[1].mover(0, 0, 0);
  }

  if (cubos[3].posicion()[2] <= 200) {
    cubos[3].desplazar(0, 0, 0.2f);
  } else {
    cubos[3].mover(0, 0, 0);
  }

  if (cubos[4].posicion()[2] <= 160) {
    cubos[4].desplazar(0, 0, 0.3f);
  } else {
...
public float grados2radianes(float grados) {
  return grados * (PI/180);
}

public float[] projection(float[] obj, float[] obj_pos) {
...
public float[] rota_x(float[] proy_old, float giro_x) {
...
public float[] rota_y(float[] proy_old, float giro_y) {
  float x = proy_old[0];
  float y = proy_old[1];
  float z = proy_old[2];
...
public float[] rota_z(float[] proy_old, float giro_z) {
  float x = proy_old[0];
  float y = proy_old[1];
  float z = proy_old[2];
...
public float[] shadow_projection(float[] obj, float[] foco_pos, float[] pos) {
...
public float[] shadow_projection2(float[] obj, float[] foco_pos, float[] pos) {
  float[] obj_proy = new float[3];
